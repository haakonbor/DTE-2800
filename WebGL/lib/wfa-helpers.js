//Genererer et tilfeldig heltall i omrï¿½det fra min til max.
...
//NY 2017: NÃ¥r Image-objektets .src settes startes nedlasting. NÃ¥r nedlastinga er ferdig kalles image.onload().
...
function loadTexture(callBackRef, textureUrl) {
    ...
    image.src = textureUrl; //onload kalles nï¿½r lasting er ferdig!
}
...
//Mappa mï¿½ ligge direkte under oppstartsprogrammet (dvs. .html fila).
...
//Laster fÃ¸rst verteksshaderen. NÃ¥r denne er komplett nedlastet kompileres denne.
//Deretter starter nedlasting av fragmentshaderen som sÃ¥ kompileres.
//NÃ¥r denne er klar kaller loadShaders() funksjonen tilbake til _callBackRef.
//_callBackRef kommer som innparameter til loadShaders() og indikerer hvilken
//funksjon som skal kalles nÃ¥r begge shaderfunksjoner er lastet og kompilert.
function GLSLShaderLoader(_vertexShaderURL, _fragmentShaderURL) {
    ...
    this.loadShaders = function(_callBackRef) {
        ...
        vsClient.onreadystatechange = function() {
            ...
            //4: forespï¿½rsel ferdig og svar foreligger.
            //200: HTPP OK
