...
function initBuffer() {
    ...
    var vertices = new Float32Array([   //NB! ClockWise!!
        Math.floor(-Math.random() *41), Math.floor(Math.random() * 41), 0,
        Math.floor(Math.random() * 41), -Math.floor(Math.random() * 41), 0,
        Math.floor(-Math.random() *41), -Math.floor(Math.random() * 41), 0,
        Math.floor(Math.random() * 41), Math.floor(Math.random() * 41), 0,
        Math.floor(-Math.random() *41), Math.floor(Math.random() * 41), 0,
    ...
    vertexBuffer.numberOfItems = 10; // NB!!
...
function draw() {
    ...
    */
    ...
    projectionMatrix.setPerspective(50, canvas.width / canvas.height, 99, 1000);
