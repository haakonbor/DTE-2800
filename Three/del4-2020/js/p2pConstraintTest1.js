...
function createJointObjects(){
	...
	let p2pConstraint = new Ammo.btPoint2PointConstraint( sphereBody, blockBody, spherePivot, blockPivot);
	physicsWorld.addConstraint( p2pConstraint, false );
}
