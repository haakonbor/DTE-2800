...
/*
* Original kode av Werner Farstad, ved filnanvn hingeTest0-js. Fjernet ballene og gjorde pinnen om til dører, og la
* til vegger.
*
* */
...
export function start(){
    ...
    createTerrain(scene);
    createBox(scene, {x:-41, y:25, z:0}, 0xf78a1d, 1000, {width: 50, height: 50, depth:5}, true);
    createBox(scene, {x:41, y:25, z:0}, 0xf78a1d, 1000, {width: 50, height: 50, depth:5}, true);
    createBox(scene);
    createHingeObject(scene, {x: -16, y: 0, z: 0}, -1);
    createHingeObject(scene, {x: 16, y: 0, z: 0}, 1);
    animate();
}
